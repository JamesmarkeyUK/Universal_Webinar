  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="hidden sm:inline-flex items-center px-1.5 py-0.5 rounded text-[10px] uppercase tracking-wide font-medium ring-1 leading-none transition-colors bg-sky-50 hover:bg-sky-100 text-sky-700 ring-sky-200"
        aria-haspopup="true"
        aria-expanded={open}
      >
        v{versionLabel}
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-96 max-w-[calc(100vw-2rem)] bg-white text-slate-900 rounded-xl shadow-2xl border border-slate-200 overflow-hidden z-[9999]">
